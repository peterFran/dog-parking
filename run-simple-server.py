...
sys.path.insert(
    0, os.path.join(os.path.dirname(__file__), "functions/owner_management")
)
sys.path.insert(
    0, os.path.join(os.path.dirname(__file__), "functions/booking_management")
)
sys.path.insert(
    0, os.path.join(os.path.dirname(__file__), "functions/payment_processing")
)

# In-memory storage (for development only)
storage = {"dogs": {}, "owners": {}, "bookings": {}, "payments": {}}
